...
def read_camera_parameters(camera_id):
    ...
    camera_mat,dist,rot_mat,t_vec = Calibration.load_camera_params(right_cam=right_cam)
    return camera_mat,dist,rot_mat,t_vec
...
def get_projection_matrix(camera_id):
    ...
    cmtx, dist,rot_mat,t_vec = read_camera_parameters(camera_id)

    #calculate projection matrix
    P = cmtx @ _make_homogeneous_rep_matrix(rot_mat, t_vec)[:3,:]
    return P
